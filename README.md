...
* 2\. [🗺️ Summary of Programming World](#%EF%B8%8F-summary-of-programming-world)
  ...
  * 2.2\. [Syntax and structure](#syntax-and-structure)
    ...
    * 2.2.2\. [Weak vs Strong typing](#weak-vs-strong-typing)
     ...
     * 2.2.5\. [Comments in C++](#comments-in-c)
     	* 2.2.5.1\. [Single-line comments](#single-line-comments)
      	* 2.2.5.2\. [Multi-line comments](#multi-line-comments)
  * 2.3\. [Members](#members)
    * 2.3.1\. [Variables](#variables)
    * 2.3.2\. [Functions](#functions)
  * 2.4\. [Classes](#classes)
  * 2.5\. [Accessibility](#accessibility)
  * 2.6\. [If-statements](#if-statements)
  * 2.7\. [Comparisons and Boolean Operators](#comparisons-and-boolean-operators)
  	* 2.7.1\. [Conditional Expressions](#conditional-expressions)
  * 2.8\. [Switches](#switches)
  * 2.9\. [Loops](#loops)
  	* 2.9.1\. [While Loop](#while-loop)
   	* 2.9.2\. [Do-While Loop](#do-while-loop)
    * 2.9.3\. [For Loop](#for-loop)
    * 2.9.4\. [Foreach Loop](#foreach-loop)
  * 2.10\. [Operators and Overloads](#operators-and-overloads)
  * 2.11\. [Lambda](#lambda)
  * 2.12\. [Polymorphism](#polymorphism)
    * 2.12.1\. [Virtual functions](#virtual-functions)
  * 2.13\. [Stack vs Heap](#stack-vs-heap)
