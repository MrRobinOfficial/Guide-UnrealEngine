...
* 22\. [🧠 Deep dive](#-deep-dive)
    ...
    * 22.3\. [🪄 Tips and best practices](#-tips-and-best-practices)
        * 22.3.1\. [📦 Refactoring](#-refactoring)
            * 22.3.1.1\. [Renaming](#renaming)
            * 22.3.1.2\. [Extract Method﻿](#extract-method)
            * 22.3.1.3\. [Introduce/Inline typedef﻿s](#introduceinline-typedefs)
            * 22.3.1.4\. [Introduce Variable﻿](#introduce-variable)
            * 22.3.1.5\. [Invert 'if' statement to reduce nesting](#invert-if-statement-to-reduce-nesting)
        * 22.3.2\. [⏱ Ticking](#-ticking)
        * 22.3.3\. [`FTickFunction`](#ftickfunction)
        * 22.3.4\. [🔌 Direct references](#-direct-references)
        * 22.3.5\. [➗ Math Expression Node](#-math-expression-node)
        * 22.3.6\. [Call function in editor](#call-function-in-editor)
