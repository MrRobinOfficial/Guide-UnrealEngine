...
* 2\. [🗺️ Quick Summary of Programming World](#%EF%B8%8F-quick-summary-of-programming-world)
  ...
  * 2.7\. [Prefixes](#prefixes)
  * 2.8\. [Constructors and Destructors](#tempy)
  * 2.9\. [🧱 Data Types](#-data-types)
    * 2.9.1\. [Char](#char)
    * 2.9.2\. [Booleans](#booleans)
    * 2.9.3\. [Integers](#integers)
    * 2.9.4\. [Floating points (floats and doubles)](#floating-points-floats-and-doubles)
    * 2.9.5\. [Modifiers/Typedefs](#modifierstypedefs)
    * 2.9.6\. [Strings](#strings)
    * 2.9.7\. [Vector, Rotator, Quat and Transform](#vector-rotator-quat-and-transform)
    * 2.9.7\. [Collections](#collections)
      * 2.9.7.1\. [TArray](#tarray)
      * 2.9.7.2\. [TSet](#tset)
      * 2.9.7.3\. [TMap](#tmap)
      * 2.9.7.4\. [TMultiMap](#tmultimap)
    * 2.9.8\. [Pointers](#pointers)
      * 2.9.8.1\. [Raw pointers](#raw-pointers)
      * 2.9.8.2\. [Smart pointers](#smart-pointers)
      * 2.9.8.3\. [TWeakObjectPtr](#tweakobjectptr)
      * 2.9.8.4\. [TWeakInterfacePtr](#tweakinterfaceptr)
      * 2.9.8.5\. [TSoftObjectPtr](#tsoftobjectptr)
      * 2.9.8.6\. [TSoftClassPtr](#tsoftclassptr)
      * 2.9.8.7\. [TSharedPtr](#tsharedptr)
