...
* 3\. [🪧 Unreal's Architecture](#-unreals-architecture)
...
* 5\. [✍️ Naming Convention](#%EF%B8%8F-naming-convention)
	...
	* 5.2\. [Synonyms](#synonyms)
* 6\. [🧱 Data Types](#-data-types)
	* 6.1\. [Char](#char)
    * 6.2\. [Booleans](#booleans)
    * 6.3\. [Integers](#integers)
    * 6.4\. [Floating points (floats and doubles)](#floating-points-floats-and-doubles)
    * 6.5\. [Modifiers/Typedefs](#modifierstypedefs)
    * 6.6\. [Strings](#strings)
    * 6.7\. [Vector, Rotator, Quat and Transform](#vector-rotator-quat-and-transform)
    * 6.7\. [Collections](#collections)
      * 6.7.1\. [TArray](#tarray)
      * 6.7.2\. [TSet](#tset)
      * 6.7.3\. [TMap](#tmap)
      * 6.7.4\. [TMultiMap](#tmultimap)
    * 6.8\. [Value type vs Reference type](#value-type-vs-reference-type)
    * 6.9\. [Pointers](#pointers)
      * 6.9.1\. [Raw pointers](#raw-pointers)
      * 6.9.2\. [Smart pointers](#smart-pointers)
      * 6.9.3\. [TWeakObjectPtr](#tweakobjectptr)
      * 6.9.4\. [TWeakInterfacePtr](#tweakinterfaceptr)
      * 6.9.5\. [TSoftObjectPtr](#tsoftobjectptr)
      * 6.9.6\. [TSoftClassPtr](#tsoftclassptr)
      * 6.9.7\. [TSharedPtr](#tsharedptr)
      * 6.9.8\. [TWeakPtr](#tweakptr)
      * 6.9.9\. [UniquePtr](#uniqueptr)
  * 7\. [💾 Soft vs hard references](#-soft-vs-hard-references)
  * 8\. [🌍 Global Functions](#-global-functions)
  * 9\. [🏛️ Libraries](#%EF%B8%8F-libraries)
  * 10\. [📃 Macros](#-macros)
  * 11\. [☑️ Assertions](#%EF%B8%8F-assertions)
  * 12\. [🔔 Delegates](#-delegates)
  * 13\. [🪪 Unreal Motion Graphics (UMG)](#-unreal-motion-graphics-umg)
  * 14\. [📚 Creating a module](#-creating-a-module)
  * 15\. [♻️ Circular Dependency](#%EF%B8%8F-circular-dependency)
  ...
  * 21\. [⚠️ Common Problems/Issues](#%EF%B8%8F-common-problemsissues)
    ...
    * 21.2\. [Compiler Error C2065](#compiler-error-c2065)
