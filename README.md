...
* 8\. [🗑️ Garbage Collection](#%EF%B8%8F-garbage-collection)
* 9\. [💎 Unreal Header Tool](#-unreal-header-tool)
  * 9.1\. [UPROPERTY](#uproperty)
  * 9.2\. [UFUNCTION](#ufunction)
  * 9.3\. [UCLASS](#uclass)
  * 9.4\. [USTRUCT](#ustruct)
  * 9.5\. [UENUM](#uenum)
  * 9.6\. [UPARAM](#uparam)
  * 9.7\. [UMETA](#umeta)
* 10\. [👷 Constructors and Destructors](#-constructors-and-destructors)
  * 10.1\. [Constructors](#constructors)
  * 10.2\. [Destructors](#destructors)
  * 10.3\. [Usage in Unreal Engine](#usage-in-unreal-engine)
* 11\. [💾 Soft vs hard references](#-soft-vs-hard-references)
  * 11.1\. [Soft References](#soft-references)
  * 11.2\. [Hard References](#hard-references)
* 12\. [🌍 Global Functions](#-global-functions)
* 13\. [🏛️ Libraries](#%EF%B8%8F-libraries)
  * 13.1\. [Kismet Library](#kismet-library)
* 14\. [📃 Macros](#-macros4)
* 15\. [☑️ Assertions](#%EF%B8%8F-assertions)
  * 15.1\. [Check](#check)
  * 15.2\. [Verify](#verify)
  * 15.3\. [Ensure](#ensure)
* 16\. [🔔 Delegates](#-delegates)
  * 16.1\. [Define a delegate type](#define-a-delegate-type)
  * 16.2\. [Declare a delegate variable](#declare-a-delegate-variable)
  * 16.3\. [Bind functions to the delegate](#bind-functions-to-the-delegate)
  * 16.4\. [Trigger the delegate](#trigger-the-delegate)
* 17\. [🪪 Unreal Motion Graphics (UMG)](#-unreal-motion-graphics-umg)
  * 17.1\. [UMG Blueprints with C++](#umg-blueprints-with-c)
  * 17.2\. [UI Tweening Library](#ui-tweening-library)
* 18\. [📚 Creating modules](#-creating-modules)
  * 18.1\. [Module structure](#module-structure)
  * 18.2\. [♻️ Circular Dependency](#%EF%B8%8F-circular-dependency)
* 19\. [💡 Creating a plugin](#-creating-a-plugin)
* 20\. [📝 preprocessor](#-preprocessor)
    * 20.1\. [Pragma once](#pragma-once)
    * 20.2\. [Strip out editor functionality](#strip-out-editor-functionality)
* 21\. [🧠 Deep dive](#-deep-dive)
    * 21.1\. [🔖 Keywords](#-keywords)
    * 21.2\. [🛸 Reflection System](#direct-references)
    * 21.3\. [🪄 Tips and best practices](#-tips-and-best-practices)
        * 21.3.1\. [📦 Refactoring](#-refactoring)
            * 21.3.1.1\. [Renaming](#renaming)
            * 21.3.1.2\. [Extract Method﻿](#extract-method)
            * 21.3.1.3\. [Introduce/Inline typedef﻿s](#introduceinline-typedefs)
            * 21.3.1.4\. [Introduce Variable﻿](#introduce-variable)
            * 21.3.1.5\. [Invert 'if' statement to reduce nesting](#invert-if-statement-to-reduce-nesting)
        * 21.3.2\. [⏱ Ticking](#-ticking)
        * 21.3.3\. [`FTickFunction`](#ftickfunction)
        * 21.3.4\. [🔌 Direct references](#-direct-references)
        * 21.3.5\. [➗ Math Expression Node](#-math-expression-node)
        * 21.3.6\. [Call function in editor](#call-function-in-editor)
* 22\. [📛 Console Commands](#-console-commands)
* 23\. [📌 Shortcuts](#-shortcuts)
* 24\. [⚠️ Common Problems/Issues](#%EF%B8%8F-common-problemsissues)
    * 24.1\. [⛔ Compiler Error C2628](#-compiler-error-c2628)
    * 24.2\. [⛔ Compiler Error C2065](#-compiler-error-c2065)
* 25\. [🔗 Helpful links](#-helpful-links)
* 26\. [🆘 Support](#-support)
