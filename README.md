...
* 2\. [🗺️ Quick Summary of Programming World](#%EF%B8%8F-quick-summary-of-programming-world)
  ...
  * 2.8\. [🧱 Data Types](#-data-types)
    ...
    * 2.8.8\. [Pointers](#pointers)
      * 2.8.8.1\. [Raw pointers](#raw-pointers)
      * 2.8.8.2\. [Smart pointers](#smart-pointers)
      * 2.8.8.3\. [TWeakObjectPtr](#tweakobjectptr)
      * 2.8.8.4\. [TWeakInterfacePtr](#tweakinterfaceptr)
      * 2.8.8.5\. [TSoftObjectPtr](#tsoftobjectptr)
      * 2.8.8.6\. [TSoftClassPtr](#tsoftclassptr)
      * 2.8.8.7\. [TSharedPtr](#tsharedptr)
      * 2.8.8.8\. [TWeakPtr](#tweakptr)
      * 2.8.8.9\. [UniquePtr](#uniqueptr)
