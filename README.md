...
* 2\. [🗺️ Quick Summary of Programming World](#%EF%B8%8F-quick-summary-of-programming-world)
  ...
  * 2.8\. [🧱 Data Types](#-data-types)
    ...
    * 2.8.3\. [Integers](#integers)
    * 2.8.4\. [Floating points (floats and doubles)](#floating-points-floats-and-doubles)
    * 2.8.5\. [Modifiers/Typedefs](#modifierstypedefs)
    * 2.8.6\. [Strings](#strings)
    * 2.8.7\. [Vector, Rotator, Quat and Transform](#vector-rotator-quat-and-transform)
    * 2.8.7\. [Collections](#collections)
      * 2.8.7.1\. [TArray](#tarray)
      * 2.8.7.2\. [TSet](#tset)
      * 2.8.7.3\. [TMap](#tmap)
      * 2.8.7.4\. [TMultiMap](#tmultimap)
    * 2.8.8\. [Value type vs Reference type](#value-type-vs-reference-type)
    * 2.8.9\. [Pointers](#pointers)
      * 2.8.9.1\. [Raw pointers](#raw-pointers)
      * 2.8.9.2\. [Smart pointers](#smart-pointers)
      * 2.8.9.3\. [TWeakObjectPtr](#tweakobjectptr)
      * 2.8.9.4\. [TWeakInterfacePtr](#tweakinterfaceptr)
      * 2.8.9.5\. [TSoftObjectPtr](#tsoftobjectptr)
      * 2.8.9.6\. [TSoftClassPtr](#tsoftclassptr)
      * 2.8.9.7\. [TSharedPtr](#tsharedptr)
      * 2.8.9.8\. [TWeakPtr](#tweakptr)
      * 2.8.9.9\. [UniquePtr](#uniqueptr)
  ...
  * 9\. [🪪 Unreal Motion Graphics (UMG)](#-unreal-motion-graphics-umg)
