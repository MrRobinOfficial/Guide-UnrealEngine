...
* 2\. [🗺️ Summary of C++ and Programming World](#%EF%B8%8F-summary-of-c-and-programming-world)
  ...
  * 2.6\. [Members](#members)
    * 2.6.1\. [Variables](#variables)
    	* 2.6.1.1\. [Assignments](#assignments)
    * 2.6.2\. [Functions](#functions)
  * 2.7\. [Classes](#classes)
  ...
  * 2.18\. [Design Patterns And Principles](#design-patterns-and-principles)
  	* 2.18.1\. [Open-Closed Principle](#open-closed-principle)
   	* 2.18.2\. [KISS (Keep It Simple, Stupid)](#kiss-keep-it-simple-stupid)
    * 2.18.3\. [Singleton](#singleton)
    * 2.18.4\. [Observer](#observer)
    * 2.18.5\. [Factory](#factory)
    * 2.18.6\. [Strategy](#strategy)
    * 2.18.7\. [MVC (Model-View-Controller)](#mvc-model-view-controller)
